...
class CategoryFilterdAPI {
  static Future <CategoryFilteredResponse> getCategoryFilterd (String id) async {
    final uri = Uri.parse('https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&with_genres=$id',);
